...
function lawyeriax_scripts() {
	...
	wp_enqueue_style( 'lato_font', 'https://fonts.googleapis.com/css?family=Lato', array(), 'v1.0', 'all' );

	wp_enqueue_style( 'custom_css', get_template_directory_uri() . '/css/custom.css', array(), 'v1.0', 'all' );
